...
!(function (e) {
    ...
    !(function (t) {
        const o = typeof define === 'function' && define.amd;
        ...
        let t;
        const o = 'mCustomScrollbar';
        const a = 'mCS';
        const n = '.mCustomScrollbar';
        const i = {
            setTop: 0,
            setLeft: 0,
            axis: 'y',
        ...
        let r = 0;
        const l = {};
        const s = window.attachEvent && !window.addEventListener ? 1 : 0;
        let c = !1;
        const d = [
            'mCSB_dragger_onDrag',
        ...
        var u = {
            init(t) {
                ...
                if (t.live) {
                    ...
                    const c = e(s);
                    if (t.live === 'off') return void m(s);
                    l[s] = setTimeout(function () {
                        c.mCustomScrollbar(t),
                            t.live === 'once' && c.length && m(s);
                    }, 500);
                } else m(s);
                return (
                    ...
                    e(o).each(function () {
                        ...
                        if (!o.data(a)) {
                            ...
                            const n = o.data(a);
                            const i = n.opt;
                            const l = o.data('mcs-axis');
                            const s = o.data('mcs-scrollbar-position');
                            const c = o.data('mcs-theme');
                            l && (i.axis = l),
            ...
            update(t, o) {
                const n = t || f.call(this);
                return e(n).each(function () {
                    const t = e(this);
                    if (t.data(a)) {
                        const n = t.data(a);
                        const i = n.opt;
                        const r = e(`#mCSB_${n.idx}_container`);
                        const l = e(`#mCSB_${n.idx}`);
                        const s = [
                        ...
                        i.axis !== 'x' &&
                            ...
                            o &&
                                ...
                                typeof i.callbacks.onImageLoad === 'function'
                ...
                if (typeof t !== 'undefined' && t != null) {
                    ...
                    return e(n).each(function () {
                        ...
                        if (n.data(a)) {
                            ...
                            const s = e.extend(!0, {}, l, o);
                            const c = Y.call(this, t);
                            const d =
            ...
            destroy() {
                ...
                return e(t).each(function () {
                    ...
                    if (n.data(a)) {
                        const i = n.data(a);
                        const r = i.opt;
                        const l = e(`#mCSB_${i.idx}`);
                        const s = e(`#mCSB_${i.idx}_container`);
                        const c = e(`.mCSB_${i.idx}_scrollbar`);
        ...
        var f = function () {
            return typeof e(this) !== 'object' || e(this).length < 1 ? n : this;
        };
        var h = function (t) {
            const o = [
                'rounded',
            ...
            const n = ['minimal', 'minimal-dark'];
            const i = ['minimal', 'minimal-dark'];
            const r = ['minimal', 'minimal-dark'];
            (t.autoDraggerLength =
        ...
        var v = function () {
            ...
            const n = t.data(a);
            const i = n.opt;
            const r = i.autoExpandScrollbar ? ` ${d[1]}_expand` : '';
            const l = [
            ...
            const s =
                i.axis === 'yx'
                    ...
                    : 'mCSB_vertical';
            const c =
                i.axis === 'yx' ? l[0] + l[1] : i.axis === 'x' ? l[1] : l[0];
            const u =
                i.axis === 'yx'
                    ? `<div id='mCSB_${n.idx}_container_wrapper' class='mCSB_container_wrapper' />`
                    : '';
            const f = i.autoHideScrollbar ? ` ${d[6]}` : '';
            const h = i.axis !== 'x' && n.langDir === 'rtl' ? ` ${d[7]}` : '';
            i.setWidth && t.css('width', i.setWidth),
                i.setHeight && t.css('height', i.setHeight),
                (i.setLeft =
                    i.axis !== 'y' && n.langDir === 'rtl'
                        ? '989999px'
                        : i.setLeft),
                t
                    .addClass(`${o} _${a}_${n.idx}${f}${h}`)
                    .wrapInner(
                        `<div id='mCSB_${n.idx}' class='mCustomScrollBox mCS-${i.theme} ${s}'><div id='mCSB_${n.idx}_container' class='mCSB_container' style='position:relative; top:${i.setTop}; left:${i.setLeft};' dir='${n.langDir}' /></div>`
                    );
            const m = e(`#mCSB_${n.idx}`);
            const p = e(`#mCSB_${n.idx}_container`);
            i.axis === 'y' ||
                i.advanced.autoExpandHorizontalScroll ||
                p.css('width', x(p)),
                i.scrollbarPosition === 'outside'
        ...
        var _ = function () {
            ...
            const o = t.data(a);
            const n = o.opt;
            const i = e(`#mCSB_${o.idx}_container`);
            if (n.advanced.autoExpandHorizontalScroll && n.axis !== 'y') {
                ...
                const r = Math.ceil(i[0].scrollWidth);
                n.advanced.autoExpandHorizontalScroll === 3 ||
                (n.advanced.autoExpandHorizontalScroll !== 2 &&
                    r > i.parent().width())
                    ? i.css({
                          width: r,
                          'min-width': '100%',
        ...
        var w = function () {
            ...
            const o = t.data(a);
            const n = o.opt;
            const i = e(`.mCSB_${o.idx}_scrollbar:first`);
            const r = oe(n.scrollButtons.tabindex)
        ...
        var S = function () {
            ...
            const d = s && c[1] < c[0] ? c[0] : c[1];
            const u = s && c[3] < c[2] ? c[2] : c[3];
            r[0]
                .css({
                    height: d,
        ...
        const C = function (e, t, o) {
            const a = o ? `${d[0]}_expanded` : '';
            const n = e.closest('.mCSB_scrollTools');
            t === 'active'
                ? (e.toggleClass(`${d[0]} ${a}`),
                  n.toggleClass(d[1]),
        ...
        var y = function () {
            ...
            const n = e(`#mCSB_${o.idx}`);
            const i = e(`#mCSB_${o.idx}_container`);
            let r = o.overflowed == null ? i.height() : i.outerHeight(!1);
            let l = o.overflowed == null ? i.width() : i.outerWidth(!1);
            const s = i[0].scrollHeight;
            const c = i[0].scrollWidth;
            return (
                s > r && (r = s),
                c > l && (l = c),
        ...
        var B = function () {
            ...
            const o = t.data(a);
            const n = o.opt;
            const i = e(`#mCSB_${o.idx}`);
            const r = e(`#mCSB_${o.idx}_container`);
            const l = [
                e(`#mCSB_${o.idx}_dragger_vertical`),
                e(`#mCSB_${o.idx}_dragger_horizontal`),
            ];
            if (
                (Q(t),
                ((n.axis !== 'x' && !o.overflowed[0]) ||
                    (n.axis === 'y' && o.overflowed[0])) &&
                    (l[0].add(r).css('top', 0), G(t, '_resetY')),
                (n.axis !== 'y' && !o.overflowed[1]) ||
                    (n.axis === 'x' && o.overflowed[1]))
            ) {
                let s = (dx = 0);
                o.langDir === 'rtl' &&
        ...
        var k = function () {
            ...
            const n = o.opt;
            const i = `${a}_${o.idx}`;
            const r = `.mCSB_${o.idx}_scrollbar`;
            const l = e(
                `#mCSB_${o.idx},#mCSB_${o.idx}_container,#mCSB_${o.idx}_container_wrapper,${r} .${d[12]},#mCSB_${o.idx}_dragger_vertical,#mCSB_${o.idx}_dragger_horizontal,${r}>a`
            );
            const s = e(`#mCSB_${o.idx}_container`);
        ...
        var M = function (t) {
            ...
            const n = o.data(a);
            const i = n.opt;
            const r = e(`#mCSB_${n.idx}_container_wrapper`);
            const l = r.length ? r : e(`#mCSB_${n.idx}_container`);
            const s = [
                e(`#mCSB_${n.idx}_scrollbar_vertical`),
                e(`#mCSB_${n.idx}_scrollbar_horizontal`),
            ];
            const c = [s[0].find('.mCSB_dragger'), s[1].find('.mCSB_dragger')];
            i.axis !== 'x' &&
                (n.overflowed[0] && !t
                    ? (s[0]
                          .add(c[0])
        ...
        var I = function () {
            ...
            var h = e(`#mCSB_${l.idx}_container`);
            const m = e(`#${f[0]},#${f[1]}`);
            const p = d.advanced.releaseDraggableSelectors
                ? m.add(e(d.advanced.releaseDraggableSelectors))
                : m;
            const g = d.advanced.extraDraggableSelectors
                ...
                .bind(
                    ...
                    function (t) {
                        if (
                            ...
                            const a = o.offset();
                            const l = O(t)[0] - a.top;
                            const u = O(t)[1] - a.left;
                            const f = o.height() + a.top;
                            const m = o.width() + a.left;
                            f > l &&
                                l > 0 &&
                                m > u &&
                                u > 0 &&
        ...
        var D = function () {
            ...
            function n(e) {
                if (
                    ...
                    const t = M.offset();
                    const o = O(e)[0] - t.top;
                    const a = O(e)[1] - t.left;
                    const n = 'mcsLinearOut';
                    if (
                        (E.push(o),
                        W.push(a),
            ...
            function r(e) {
                if (te(e) && !c && !O(e)[2]) {
                    ...
                    if (!(v - g > 30)) {
                        ...
                        const u = [Math.abs(x[0]), Math.abs(x[1])];
                        _ = i
                        ...
                        const y = parseInt(T.contentTouchScroll) || 0;
                        (w[0] = u[0] > y ? w[0] : 0),
                            (w[1] = u[1] > y ? w[1] : 0),
            ...
            const k = `${a}_${B.idx}`;
            var M = e(`#mCSB_${B.idx}`);
            var I = e(`#mCSB_${B.idx}_container`);
            var D = [
            ...
            var W = [];
            var R = 0;
            var L = T.axis === 'yx' ? 'none' : 'all';
            var z = [];
            const P = I.find('iframe');
            const H = [
        ...
        var E = function () {
            ...
            var d = l.sequential;
            const u = `${a}_${l.idx}`;
            const f = e(`#mCSB_${l.idx}_container`);
            const h = f.parent();
            f.bind(`mousedown.${u}`, function () {
                ...
                .bind(`mousemove.${u}`, function (e) {
                    if (!t && i && o()) {
                        const a = f.offset();
                        const r = O(e)[0] - a.top + f[0].offsetTop;
                        const c = O(e)[1] - a.left + f[0].offsetLeft;
        ...
        var W = function () {
            ...
            if (e(this).data(a)) {
                ...
                const d = e(`#mCSB_${n.idx}_container`).find('iframe');
                d.length &&
                    d.each(function () {
                        e(this).bind('load', function () {
                            A(this) &&
        ...
        var z = function (t, o) {
            ...
            const i = t.data(a).opt.mouseWheel.disableOver;
        ...
        var P = function () {
            ...
            const r = e(`#mCSB_${n.idx}_container`);
            const l = r.parent();
            const s = e(`.mCSB_${n.idx}_scrollbar .${d[12]}`);
            s.bind(
                ...
                .bind(`click.${i}`, function (a) {
                    if (
                        ...
                        Q(o);
                        const i = e(this);
                        const s = i.find('.mCSB_dragger');
                        if (
                            i.parent('.mCSB_scrollTools_horizontal').length > 0
                        ) {
                            if (!n.overflowed[1]) return;
                            var c = 'x';
                            var u = a.pageX > s.offset().left ? -1 : 1;
                            var f =
                                Math.abs(r[0].offsetLeft) -
                                u * (0.9 * l.width());
                        } else {
                            ...
                            var c = 'y';
                            var u = a.pageY > s.offset().top ? -1 : 1;
                            var f =
                                Math.abs(r[0].offsetTop) -
                                u * (0.9 * l.height());
                        }
        ...
        var H = function () {
            ...
            r.bind(`focusin.${i}`, function () {
                ...
                const a = r.find('.mCustomScrollBox').length;
                const i = 0;
                o.is(n.advanced.autoScrollOnFocus) &&
                    ...
                    (t[0]._focusTimeout = setTimeout(function () {
                        const e = [ae(o)[0], ae(o)[1]];
                        const a = [r[0].offsetTop, r[0].offsetLeft];
                        const s = [
                            a[0] + e[0] >= 0 &&
        ...
        var U = function () {
            ...
            const o = t.data(a);
            const n = `${a}_${o.idx}`;
            const i = e(`#mCSB_${o.idx}_container`).parent();
        ...
        var F = function () {
            ...
            const o = t.data(a);
            const n = o.opt;
            const i = o.sequential;
            const r = `${a}_${o.idx}`;
            const l = `.mCSB_${o.idx}_scrollbar`;
            const s = e(`${l}>a`);
            s.bind(`contextmenu.${r}`, function (e) {
                e.preventDefault();
            }).bind(
                `mousedown.${r} touchstart.${r} pointerdown.${r} MSPointerDown.${r} mouseup.${r} touchend.${r} pointerup.${r} MSPointerUp.${r} mouseout.${r} pointerout.${r} MSPointerOut.${r} click.${r}`,
                function (a) {
                    function r(e, o) {
                    ...
                    if ((a.preventDefault(), ee(a))) {
                        ...
                        switch (
                            ...
                            case 'MSPointerOut':
                                ...
                                break;
                            case 'click':
                                if (i.type !== 'stepped' || o.tweenRunning)
                                    return;
                                r('on', l);
                        }
                    }
        ...
        var q = function () {
            function t(t) {
                function a(e, t) {
                    (r.type = i.keyboard.scrollType),
                        ...
                        (r.type === 'stepped' && n.tweenRunning) || j(o, e, t);
                }
                switch (t.type) {
                    case 'blur':
                    ...
                    case 'keyup':
                        ...
                        if (
                            ...
                            if (
                                ((l === 38 || l === 40) && !n.overflowed[0]) ||
                                ((l === 37 || l === 39) && !n.overflowed[1])
                            )
                                return;
                            t.type === 'keyup' && (s = 'off'),
            ...
            var r = n.sequential;
            const l = `${a}_${n.idx}`;
            const s = e(`#mCSB_${n.idx}`);
            var c = e(`#mCSB_${n.idx}_container`);
            var d = c.parent();
            var u =
                "input,textarea,select,datalist,keygen,[contenteditable='true']";
            const f = c.find('iframe');
            const h = [`blur.${l} keydown.${l} keyup.${l}`];
            f.length &&
                f.each(function () {
                    e(this).bind('load', function () {
                        A(this) &&
        ...
        var j = function (t, o, n, i, r) {
            function l(e) {
                    ...
                    (f.scrollAmount =
                        u.snapAmount instanceof Array
                            ? f.dir[0] === 'x'
                                ...
                                : u.snapAmount[0]
                            : u.snapAmount);
                const o = f.type !== 'stepped';
                const a = r || (e ? (o ? p / 1.5 : g) : 1e3 / 60);
                const n = e ? (o ? 7.5 : 40) : 2.5;
                const s = [Math.abs(h[0].offsetTop), Math.abs(h[0].offsetLeft)];
                const d = [
                ...
                let x = f.scrollAmount !== 'auto' ? v : m;
                const _ =
                    i ||
                    (e ? (o ? 'mcsLinearOut' : 'mcsEaseInOut') : 'mcsLinear');
                const w = !!e;
                return (
                    e && a < 17 && (x = f.dir[0] === 'x' ? s[1] : s[0]),
                    G(t, x.toString(), {
                        dir: f.dir[0],
                        scrollEasing: _,
                        dur: a,
            ...
            var u = c.opt;
            var f = c.sequential;
            var h = e(`#mCSB_${c.idx}_container`);
            const m = f.type === 'stepped';
            var p = u.scrollInertia < 26 ? 26 : u.scrollInertia;
            var g = u.scrollInertia < 1 ? 17 : u.scrollInertia;
            switch (o) {
                case 'on':
                    if (
                        ((f.dir = [
                            n === d[16] || n === d[15] || n === 39 || n === 37
                                ? 'x'
                                : 'y',
                            n === d[13] || n === d[15] || n === 38 || n === 37
                                ? -1
                                : 1,
                        ]),
                        Q(t),
                ...
                t instanceof Array
                    ? (n =
                          t.length > 1
                              ...
                              ? [null, t[0]]
                              : [t[0], null])
                    : ((n[0] = t.y ? t.y : t.x || o.axis === 'x' ? null : t),
                      (n[1] = t.x ? t.x : t.y || o.axis === 'y' ? null : t)),
                typeof n[0] === 'function' && (n[0] = n[0]()),
                typeof n[1] === 'function' && (n[1] = n[1]()),
                n
            );
        };
        var X = function (t, o) {
            if (t != null && typeof t !== 'undefined') {
                ...
                const i = n.data(a);
                const r = i.opt;
                const l = e(`#mCSB_${i.idx}_container`);
                const s = l.parent();
                const c = typeof t;
                o || (o = r.axis === 'x' ? 'x' : 'y');
                const d =
                ...
                const f = o === 'x' ? l[0].offsetLeft : l[0].offsetTop;
                const h = o === 'x' ? 'left' : 'top';
                switch (c) {
                    case 'function':
                        return t();
                    case 'object':
        ...
        var N = function (t) {
            ...
            function i() {
                c.advanced.updateOnSelectorChange === !0 &&
                    (c.advanced.updateOnSelectorChange = '*');
                let e = 0;
                const t = f.find(c.advanced.updateOnSelectorChange);
                return (
                    c.advanced.updateOnSelectorChange &&
                        t.length > 0 &&
                        t.each(function () {
            ...
            var s = l.data(a);
            var c = s.opt;
            var f = e(`#mCSB_${s.idx}_container`);
            return t
                ? (clearTimeout(f[0].autoUpdate), void $(f[0], 'autoUpdate'))
                : void o();
        };
        const V = function (e, t, o) {
            return Math.round(e / t) * t - o;
        };
        var Q = function (t) {
            const o = t.data(a);
            const n = e(
                `#mCSB_${o.idx}_container,#mCSB_${o.idx}_container_wrapper,#mCSB_${o.idx}_dragger_vertical,#mCSB_${o.idx}_dragger_horizontal`
            );
            n.each(function () {
                Z.call(this);
            });
        };
        var G = function (t, o, n) {
            function i(e) {
                return (
                    s && c.callbacks[e] && typeof c.callbacks[e] === 'function'
                );
            }
            function r() {
                return [
            ...
            function l() {
                const e = [h[0].offsetTop, h[0].offsetLeft];
                const o = [x[0].offsetTop, x[0].offsetLeft];
                const a = [h.outerHeight(!1), h.outerWidth(!1)];
                const i = [f.height(), f.width()];
                t[0].mcs = {
                    content: h,
                    top: e[0],
                    left: e[1],
            ...
            var n = e.extend(d, n);
            const u = [n.dur, n.drag ? 0 : n.dur];
            var f = e(`#mCSB_${s.idx}`);
            var h = e(`#mCSB_${s.idx}_container`);
            const m = h.parent();
            const p = c.callbacks.onTotalScrollOffset
                ? Y.call(t, c.callbacks.onTotalScrollOffset)
                : [0, 0];
            const g = c.callbacks.onTotalScrollBackOffset
                ? Y.call(t, c.callbacks.onTotalScrollBackOffset)
                : [0, 0];
            if (
                ((s.trigger = n.trigger),
                (m.scrollTop() === 0 && m.scrollLeft() === 0) ||
                ...
                switch (n.dir) {
                    case 'x':
                        ...
                        var _ = 'left';
                        var w = h[0].offsetLeft;
                        var S = [
                            f.width() - h.outerWidth(!1),
                            x.parent().width() - x.width(),
                        ];
                        var b = [o, o === 0 ? 0 : o / s.scrollRatio.x];
                        var y = p[1];
                        var B = g[1];
                        var T = y > 0 ? y / s.scrollRatio.x : 0;
                        var k = B > 0 ? B / s.scrollRatio.x : 0;
                        break;
                    case 'y':
                        ...
                        var b = [o, o === 0 ? 0 : o / s.scrollRatio.y];
                        var y = p[0];
                        var B = g[0];
                        var T = y > 0 ? y / s.scrollRatio.y : 0;
                        var k = B > 0 ? B / s.scrollRatio.y : 0;
                }
                b[1] < 0 || (b[0] === 0 && b[1] === 0)
                    ? (b = [0, 0])
                    : b[1] >= S[1]
        ...
        var J = function (e, t, o, a, n, i, r) {
            ...
            let h;
            var r = r || {};
            var m = r.onStart || function () {};
            var p = r.onUpdate || function () {};
            var g = r.onComplete || function () {};
            var v = K();
            var x = 0;
            var _ = e.offsetTop;
            var w = e.style;
            var S = e._mTween[t];
            t === 'left' && (_ = e.offsetLeft);
            var b = o - _;
            (S.stop = 0), i !== 'none' && d(), c();
        };
        var K = function () {
        ...
        var Z = function () {
            const e = this;
            e._mTween || (e._mTween = { top: {}, left: {} });
            for (let t = ['top', 'left'], o = 0; o < t.length; o++) {
                const a = t[o];
                e._mTween[a].id &&
                    (window.requestAnimationFrame
        ...
        var ae = function (e) {
            const t = e.parents('.mCSB_container');
            return [
                    ...
                    e.extend(e.expr[':'], {
                        mcsInView:
                            ...
                            function (t) {
                                ...
                                let a;
                                const n = e(t);
                                const i = n.parents('.mCSB_container');
                                if (i.length)
                                    return (
                                        (o = i.parent()),
                        ...
                        mcsInSight:
                            ...
                            function (t, o, a) {
                                ...
                                let l;
                                const s = e(t);
                                const c = s.parents('.mCSB_container');
                                const d =
                                    a[3] === 'exact'
                                        ? [
                                              [1, 0],
