...
/* harmony export */   Fancybox: function() { return /* binding */ _t; },
...
var menuFunctionality = function menuFunctionality() {
  ...
  var isMenuOverflowing = function isMenuOverflowing() {
    var subMenu = document.querySelector('.menu-item-has-children.opened > .sub-menu');
    console.log(subMenu);
    var offset = 100;
    if (subMenu) {
      var subMenuRect = subMenu.getBoundingClientRect();
      var bodyRect = document.body.getBoundingClientRect();
      var overflowDistance = Math.floor(subMenuRect.right - bodyRect.right);
      if (overflowDistance > 0) {
        subMenu.style.left = "-".concat(Math.floor(overflowDistance + offset), "px");
      }
    }
  };
  ...
  menuItemHasChildrenArray && menuItemHasChildrenArray.forEach(function (hasChildrenItem) {
    if (isHoverAvailable()) {
      hasChildrenItem.addEventListener('mouseenter', function () {
        return toggleSubMenuClass('add', hasChildrenItem);
      });
      hasChildrenItem.addEventListener('mouseleave', function () {
        return toggleSubMenuClass('remove', hasChildrenItem);
      });
    } else {
      hasChildrenItem.addEventListener('click', function () {
        return toggleSubMenuClass('toggle', hasChildrenItem);
      });
    }
  });
};
var activateMobileMenu = function activateMobileMenu() {
  ...
  addActiveItems && addActiveItems.forEach(function (item) {
    item.classList.toggle('active');
  });
  document.body.classList.toggle('popup-opened');
};
var footerMenuAction = function footerMenuAction() {
  var footerMenuLink = document.querySelectorAll('.site-footer__menu .menu-title a');
  footerMenuLink && footerMenuLink.forEach(function (link) {
...
function InitSwiperIndustry() {
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.js-swiper-industry', {
...
function InitSwiperCertificates() {
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.swiper-certificates', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation],
    spaceBetween: 16,
    slidesPerView: 1,
    breakpoints: {
...
function employeeReviewsSlider() {
  var prevBtn = window.innerWidth > 1470 ? '.swiper-button-prev' : '.swiper-button-prev-mob';
  var nextBtn = window.innerWidth > 1470 ? '.swiper-button-next' : '.swiper-button-next-mob';
  var swiper = new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.js-employee-reviews-slider', {
    modules: [swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation],
    spaceBetween: 16,
    slidesPerView: 1,
    breakpoints: {
...
var Sliders = {
  ...
  InitSwiperIndustry: InitSwiperIndustry,
  employeeReviewsSlider: employeeReviewsSlider,
  InitSwiperCertificates: InitSwiperCertificates
};
...
/* harmony import */ var _components_menu_functionality__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components/menu-functionality */ "./src/js/components/menu-functionality.ts");
...
/* harmony import */ var _components_display_file_name_for_input__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/display-file-name-for-input */ "./src/js/components/display-file-name-for-input.ts");
...
function ready() {
  ...
  popupInstance.init();
  _fancyapps_ui__WEBPACK_IMPORTED_MODULE_1__.Fancybox.bind('[data-fancybox="awards"]', {
    hideScrollbar: false
  });
  _fancyapps_ui__WEBPACK_IMPORTED_MODULE_1__.Fancybox.bind('[data-fancybox="certificate"]', {
    hideScrollbar: false
  });
  var siteHeader = document.querySelector('#site-header');
  var addActiveItems = document.querySelectorAll('.js-toggle-active-menu');
