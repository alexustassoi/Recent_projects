...
;// CONCATENATED MODULE: ./src/js/components/menu-functionality.ts
...
function InitSwiperIndustry() {
  var swiper = new Swiper('.js-swiper-industry', {
    modules: [Navigation],
    spaceBetween: 16,
    slidesPerView: 1,
    breakpoints: {
...
function employeeReviewsSlider() {
  var swiper = new Swiper('.js-employee-reviews-slider', {
    modules: [Navigation],
    spaceBetween: 16,
    slidesPerView: 1,
    breakpoints: {
...
;// CONCATENATED MODULE: ./src/js/components/display-file-name-for-input.ts
...
/* harmony default export */ var display_file_name_for_input = (displayFileNameForInput);
...
function ready() {
  ...
  popupInstance.init();
  var siteHeader = document.querySelector('#site-header');
  swiper_init.InitSwiperIndustry();
  swiper_init.initSwipers();
  swiper_init.employeeReviewsSlider();
  menuFunctionality();
  footerMenuAction();
  display_file_name_for_input();
